...
@section('title', 'ui-alerts-popups')
...
<!-- START SCRIPTS -->
    ...
    <script type='text/javascript' src="{{asset('backend/js/plugins/noty/layouts/topCenter.js')}}"></script>
    <script type='text/javascript' src="{{asset('backend/js/plugins/noty/layouts/topLeft.js')}}"></script>
