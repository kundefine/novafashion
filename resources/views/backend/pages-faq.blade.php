...
@push('footer-scripts')
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="{{asset('backend/js/plugins/highlight/jquery.highlight-4.js')}}"></script>
        ...
        <script type="text/javascript" src="{{asset('backend/js/faq.js')}}"></script>
        <!-- END TEMPLATE -->
