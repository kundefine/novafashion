...
@section('title', 'pages-address-book')
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body profile">
                            <div class="profile-image">
                                <img src="{{asset('backend/assets/images/users/user4.jpg')}}" alt="Brad Pitt"/>
                            </div>
                            <div class="profile-data">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body profile">
                            <div class="profile-image">
                                <img src="{{asset('backend/assets/images/users/user5.jpg')}}" alt="John Travolta"/>
                            </div>
                            <div class="profile-data">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body profile">
                            <div class="profile-image">
                                <img src="{{asset('backend/assets/images/users/user6.jpg')}}" alt="Darth Vader"/>
                            </div>
                            <div class="profile-data">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body profile">
                            <div class="profile-image">
                                <img src="{{asset('backend/assets/images/users/user7.jpg')}}" alt="Samuel Leroy Jackson"/>
                            </div>
                            <div class="profile-data">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body profile">
                            <div class="profile-image">
                                <img src="{{asset('backend/assets/images/users/no-image.jpg')}}" alt="Samuel Leroy Jackson"/>
                            </div>
                            <div class="profile-data">
