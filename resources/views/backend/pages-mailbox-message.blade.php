...
@section('title', 'pages-mailbox-message')
...
@section('page-content')
    <div class="page-content">
        ...
        @component('backend.components.page-content-common', [
            'page_title' => 'Message',
            'page_title_icon' => 'fa fa-file-text'
        ]);
        @endcomponent
            ...
            <div class="content-frame-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <img src="{{asset('backend/assets/images/users/user2.jpg')}}" class="panel-title-image" alt="John Doe"/>
