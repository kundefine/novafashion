...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
            <div class="page-sidebar" id="tour-sidebar">
                <!-- START X-NAVIGATION -->
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="ui-tour.html"><span class="fa fa-random"></span> Tour</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable">
            ...
            <div class="page-content">
                ...
                <ul class="x-navigation x-navigation-horizontal x-navigation-panel" id="tour-top-navigation">
                    <!-- TOGGLE NAVIGATION -->
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="{{asset('backend/js/plugins/tour/bootstrap-tour.min.js')}}"></script>        
        <script type="text/javascript" src="{{asset('backend/js/plugins/tour/bootstro.min.js')}}"></script>
        <!-- END PAGE PLUGINS -->        
