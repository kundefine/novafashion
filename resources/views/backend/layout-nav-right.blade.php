...
@section('title', 'layout-nav-right')
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            Add class <code>.page-mode-rtl</code> to <code>.page-container</code> to set right direction for navigation.
                        </div>
                    </div>
                </div>
            </div>
